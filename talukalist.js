talukaList = {
  ...
  "Gondia": ["Gondia", "Tirora", "Goregaon", "Arjuni", "Amgaon", "Salekasa", "Sadak Arjuni", "Deori"],
  ...
  "Nagpur": ["Nagpur (Urban)", "Kamptee", "Hingna", "Katol", "Narkhed", "Savner", "Kalameshwar", "Ramtek", "Mouda", "Parseoni", "Umred", "Kuhi", "Bhiwapur"],
  ...
  "Pune": ["Pune", "Khed", "Junnar", "Ambegaon", "Maval", "Mulshi", "Shirur", "Purandhar", "Velhe", "Bhor", "Baramati", "Indapur", "Daund"],
  ...
  "Latur": ["Latur", "Renapur", "Ahmedpur", "Jalkot", "Chakur", "Shirur", "Ausa", "Nilanga", "Deoni", "Udgir"],
  "Satara": ["Satara", "Jaoli", "Koregaon", "Wai", "Mahabaleshwar", "Khandala", "Phaltan", "Maan", "Khata", "Patan", "Karad"],
